...
| isFistOfSelected | boolean | True if this is the first of a contiguous group of selected rows. This can be used to tastfully style a group of selected items. Maybe a different border radius on the first and last rows?
